...
#'
#' \code{LL08.C02} returns the ground-motion prediction with it sigma of adjusted Lin and Lee(2008) GMPE.
#'
...
#'
#' @export
LL08.C02 <- function(Mag, Rrup, Ztor, ftype=0, Prd, Vs30=760) {
